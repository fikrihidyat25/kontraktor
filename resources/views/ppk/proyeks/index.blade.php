<x-app-layout>
    ...
    <div class="content-area">
        <div style="display:flex; justify-content:flex-end; margin-bottom:14px;">
            <a href="{{ route('ppk.proyeks.create') }}" class="btn-primary" style="text-decoration:none;">+ Tambah Proyek Baru</a>
        </div>

        <div style="border:1px solid var(--border); overflow-x:auto; border-radius:4px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <form method="POST" action="{{ route('ppk.proyeks.destroy', $p) }}" onsubmit="return confirm('Hapus proyek {{ $p->nama_proyek }}?')">
                                @csrf @method('DELETE')
