<x-app-layout>
    ...
    <div class="content-area">
        <div style="display:flex; justify-content:flex-end; margin-bottom:14px;">
            <a href="{{ route('ppk.users.create') }}" class="btn-primary" style="text-decoration:none;">+ Tambah Pengguna Baru</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <form method="POST" action="{{ route('ppk.users.destroy', $u) }}" onsubmit="return confirm('Hapus pengguna {{ $u->name }}?')">
                                @csrf @method('DELETE')
