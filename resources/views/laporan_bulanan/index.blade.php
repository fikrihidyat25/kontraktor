    ...
    <div class="w-full font-sans">
        ...
        <div class="flex justify-between items-center mb-8 bg-white p-6 md:px-10 border-b border-gray-200">
            <div>
                ...
                <p class="text-sm text-[#64748B] mt-1">Daftar rekapan progres fisik proyek secara bulanan (Dibuat otomatis setiap 4 minggu).</p>
            </div>
        </div>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 text-[#0F172B] whitespace-nowrap font-medium">{{ $l->bulan_label }}</td>
